            ...
            <div className="max-w-lg w-full bg-slate-300">
                ...
                <div className="w-full p-8">
                    ...
                    <ol className="list-decimal pl-5 mt-2">
                        ...
                        <li className="mt-2">
                            Pengguna mungkin akan menemui satu definisi dengan penjelasan yang berbeda. Hal ini terjadi karena pada dasarnya definisi bisa dibatasi konteks yang dinyatakan dalam setiap regulasi. Dalam Ketentuan Umum peraturan perundang-undangan umumnya  dicantumkan kalimat “Dalam … (diisi jenis peraturan perundang-undangan) ini yang dimaksud dengan: ....”. Hal ini menjadi batasan dari konteks atas penjelasan definisi dimaksud. Selain itu, beberapa definisi mungkin berasal dari Undang-Undang yang sudah tidak berlaku.
                        </li>
                    </ol>
